<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            @if (auth()->user()->hasPermission('read_attendances'))
                <li><a href="{{ url('/dashboard/attendance') }}"><i class="fa fa-th"></i><span>Attendances</span></a></li>
            @endif

            @if (auth()->user()->hasPermission('read_users'))
                <li><a href="{{ route('dashboard.employee.index') }}"><i class="fa fa-th"></i><span>Employees</span></a></li>
        @endif

            @if (auth()->user()->hasPermission('read_schedules'))
                <li><a href="{{ route('dashboard.schedule.index') }}"><i class="fa fa-th"></i><span>Schedules</span></a></li>
        @endif
                @if (auth()->user()->hasPermission('read_hours'))
                    <li><a href="{{ url('/dashboard/hours') }}"><i class="fa fa-th"></i><span>Employee_hourse</span></a></li>
            @endif
